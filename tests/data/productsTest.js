...
describe('test suite: Product', () =>
    {
        ...
        it('object has the correct priceCents', () => 
            {
                expect(product.priceCents).toEqual(1090);
            }
        );

        it('object has correct extraInfoHTML method', () => 
            {
                const html = product.extraInfoHTML();
                expect(html).toEqual('');
            }
        );
    }
