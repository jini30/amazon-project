  ...
  cart.forEach((cartItem) =>
    {
      ...
      const deliveryDate = calculateDeliveryDate(getDeliveryOption(cartItem.deliveryOptionId));
      ...
      cartSummaryHTML += `<div class="cart-item-container js-cart-item-container js-cart-item-container-${matchingProduct.id}">
            ...
            <input class="quantity-input js-input-quantity-${matchingProduct.id}" data-product-id="${matchingProduct.id}">
